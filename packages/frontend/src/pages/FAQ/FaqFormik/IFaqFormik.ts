// types
import { ContactMessageTouched } from '@pages/Contact/store/reducer';
import { ContactMessage } from '@pages/Contact/store/types';

import { MapDispatchToProps, MapStateToProps } from 'react-redux';
import { AppThunkDispatch } from '@store/AppThunkDispatch';
import { AppState } from '@store/RootReducer';

import { postNewMessage as postNewMessageAction } from '@pages/Contact/store/actions';
