const countries = [
    ...
    { "id": 2, "name": "Aland Islands", "cities": ["Mariehamn"] },
    {
        "id": 3,
        "name": "Albania",
        "cities": [
    ...
    { "id": 5, "name": "American Samoa", "cities": ["Pago Pago"] },
    { "id": 6, "name": "Andorra", "cities": ["les Escaldes", "Andorra la Vella"] },
    {
        "id": 7,
        "name": "Angola",
        "cities": [
    ...
    { "id": 8, "name": "Anguilla", "cities": ["The Valley"] },
    { "id": 9, "name": "Antigua and Barbuda", "cities": ["Saint John’s"] },
    {
        "id": 10,
        "name": "Argentina",
        "cities": [
    ...
    { "id": 12, "name": "Aruba", "cities": ["Oranjestad", "Babijn", "Angochi"] },
    {
        "id": 13,
        "name": "Australia",
        "cities": [
    ...
    { "id": 16, "name": "Bahamas", "cities": ["Nassau", "Lucaya", "Freeport"] },
    {
        "id": 17,
        "name": "Bahrain",
        "cities": [
    ...
    { "id": 19, "name": "Barbados", "cities": ["Bridgetown"] },
    {
        "id": 20,
        "name": "Belarus",
        "cities": [
    ...
    },
    {
        "id": 22,
        "name": "Belize",
        "cities": ["San Ignacio", "Orange Walk", "Belmopan", "Belize City"]
    },
    {
        "id": 23,
        "name": "Benin",
    ...
    { "id": 24, "name": "Bermuda", "cities": ["Hamilton"] },
    { "id": 25, "name": "Bhutan", "cities": ["Thimphu", "Punākha", "Phuntsholing", "Tsirang"] },
    {
        "id": 26,
        "name": "Bolivia",
        "cities": [
    ...
    { "id": 27, "name": "Bonaire, Saint Eustatius and Saba", "cities": ["Kralendijk"] },
    {
        "id": 28,
    ...
    { "id": 31, "name": "British Virgin Islands", "cities": ["Road Town", "Tortola"] },
    {
        "id": 32,
        "name": "Brunei",
        "cities": ["Tutong", "Seria", "Kuala Belait", "Bandar Seri Begawan"]
    },
    {
        "id": 33,
        "name": "Bulgaria",
    ...
    },
    {
        "id": 39,
        "name": "Cape Verde",
        "cities": ["Santa Maria", "Praia", "Mindelo", "Cova Figueira"]
    },
    { "id": 40, "name": "Cayman Islands", "cities": ["George Town"] },
    {
        "id": 41,
    ...
    { "id": 45, "name": "Christmas Island", "cities": ["Flying Fish Cove"] },
    { "id": 46, "name": "Cocos Islands", "cities": ["West Island"] },
    {
        "id": 47,
        "name": "Colombia",
        "cities": [
    ...
    { "id": 48, "name": "Comoros", "cities": ["Moutsamoudou", "Moroni"] },
    { "id": 49, "name": "Cook Islands", "cities": ["Avarua"] },
    {
        "id": 50,
        "name": "Costa Rica",
        "cities": [
    ...
    { "id": 53, "name": "Curacao", "cities": ["Willemstad"] },
    {
        "id": 54,
        "name": "Cyprus",
        "cities": ["Protaras", "Paphos", "Nicosia", "Limassol", "Larnaca", "Kyrenia", "Famagusta"]
    },
    {
        "id": 55,
        "name": "Czech Republic",
    ...
    },
    {
        "id": 58,
        "name": "Djibouti",
        "cities": ["Tadjoura", "Obock", "Djibouti", "Ḏânan", "'Ali Sabieh"]
    },
    { "id": 59, "name": "Dominica", "cities": ["Roseau"] },
    {
        "id": 60,
    ...
    { "id": 65, "name": "Equatorial Guinea", "cities": ["Ebebiyin", "Malabo", "Bata"] },
    {
        "id": 66,
        "name": "Eritrea",
        "cities": ["Massawa", "Keren", "Barentu", "Asmara", "Assab", "Mendefera"]
    },
    {
        "id": 67,
        "name": "Estonia",
    ...
    { "id": 69, "name": "Falkland Islands", "cities": ["Stanley"] },
    { "id": 70, "name": "Faroe Islands", "cities": ["Tórshavn"] },
    { "id": 71, "name": "Fiji", "cities": ["Suva", "Nadi", "Lautoka", "Labasa"] },
    {
        "id": 72,
        "name": "Finland",
        "cities": [
    ...
    },
    {
        "id": 74,
        "name": "French Guiana",
        "cities": ["Saint-Laurent-du-Maroni", "Rémire-Montjoly", "Matoury", "Kourou", "Cayenne"]
    },
    { "id": 75, "name": "French Polynesia", "cities": ["Punaauia", "Papeete", "Faaa"] },
    { "id": 76, "name": "French Southern Territories", "cities": ["Port-aux-Français"] },
    {
        "id": 77,
        "name": "Gabon",
        "cities": [
    ...
    },
    {
        "id": 78,
        "name": "Gambia",
        "cities": ["Sukuta", "Lamin", "Farafenni", "Brikama", "Banjul", "Bakau"]
    },
    {
        "id": 79,
        "name": "Georgia",
    ...
    { "id": 82, "name": "Gibraltar", "cities": ["Gibraltar"] },
    {
        "id": 83,
        "name": "Greece",
        "cities": [
    ...
    { "id": 84, "name": "Greenland", "cities": ["Nuuk"] },
    { "id": 85, "name": "Grenada", "cities": ["Saint George's"] },
    {
        "id": 86,
        "name": "Guadeloupe",
        "cities": [
    ...
    { "id": 89, "name": "Guernsey", "cities": ["Saint Peter Port"] },
    {
        "id": 90,
        "name": "Guinea",
        "cities": [
    ...
    { "id": 91, "name": "Guinea-Bissau", "cities": ["Bissau", "Bafatá"] },
    { "id": 92, "name": "Guyana", "cities": ["New Amsterdam", "Linden", "Georgetown"] },
    {
        "id": 93,
        "name": "Haiti",
        "cities": [
    ...
    },
    {
        "id": 97,
        "name": "Iceland",
        "cities": ["Akureyri", "Reykjavík", "Kópavogur", "Hafnarfjörður"]
    },
    {
        "id": 98,
        "name": "India",
    ...
    { "id": 103, "name": "Isle of Man", "cities": ["Douglas"] },
    {
        "id": 104,
        "name": "Israel",
        "cities": [
    ...
    { "id": 109, "name": "Jersey", "cities": ["Saint Helier"] },
    {
        "id": 110,
        "name": "Jordan",
        "cities": [
    ...
    { "id": 113, "name": "Kiribati", "cities": ["Tarawa"] },
    {
        "id": 114,
        "name": "Kosovo",
        "cities": [
    ...
    { "id": 123, "name": "Liechtenstein", "cities": ["Vaduz"] },
    {
        "id": 124,
        "name": "Lithuania",
        "cities": [
    ...
    { "id": 125, "name": "Luxembourg", "cities": ["Luxembourg", "Esch-sur-Alzette", "Dudelange"] },
    { "id": 126, "name": "Macao", "cities": ["Macau"] },
    {
        "id": 127,
        "name": "Macedonia",
        "cities": [
    ...
    { "id": 131, "name": "Maldives", "cities": ["Male"] },
    {
        "id": 132,
        "name": "Mali",
        "cities": [
    ...
    },
    {
        "id": 133,
        "name": "Malta",
        "cities": ["Żabbar", "Valletta", "Qormi", "Mosta", "Birkirkara"]
    },
    { "id": 134, "name": "Marshall Islands", "cities": ["Majuro", "RMI Capitol"] },
    {
        "id": 135,
        "name": "Martinique",
        "cities": [
    ...
    { "id": 138, "name": "Mayotte", "cities": ["Mamoudzou", "Dzaoudzi", "Koungou"] },
    {
        "id": 139,
        "name": "Mexico",
        "cities": [
    ...
    { "id": 140, "name": "Micronesia", "cities": ["Palikir - National Government Center"] },
    {
        "id": 141,
        "name": "Moldova",
        "cities": [
    ...
    { "id": 142, "name": "Monaco", "cities": ["Monte-Carlo", "Monaco"] },
    {
        "id": 143,
        "name": "Mongolia",
        "cities": [
    ...
    { "id": 145, "name": "Montserrat", "cities": ["Plymouth", "Brades"] },
    {
        "id": 146,
        "name": "Morocco",
        "cities": [
    ...
    { "id": 150, "name": "Nauru", "cities": ["Yaren"] },
    {
        "id": 151,
        "name": "Nepal",
        "cities": [
    ...
    { "id": 153, "name": "New Caledonia", "cities": ["Nouméa", "Mont-Dore", "Dumbéa"] },
    {
        "id": 154,
        "name": "New Zealand",
        "cities": [
    ...
    { "id": 158, "name": "Niue", "cities": ["Alofi"] },
    { "id": 159, "name": "Norfolk Island", "cities": ["Kingston"] },
    {
        "id": 160,
        "name": "North Korea",
        "cities": [
    ...
    { "id": 161, "name": "Northern Mariana Islands", "cities": ["Saipan"] },
    {
        "id": 162,
        "name": "Norway",
        "cities": [
    ...
    { "id": 165, "name": "Palau", "cities": ["Melekeok"] },
    {
        "id": 166,
    ...
    { "id": 172, "name": "Pitcairn", "cities": ["Adamstown"] },
    {
        "id": 173,
        "name": "Poland",
        "cities": [
    ...
    },
    {
        "id": 176,
        "name": "Qatar",
        "cities": ["Umm Şalāl Muḩammad", "Ar Rayyān", "Al Wakrah", "Al Khawr", "Doha"]
    },
    {
        "id": 177,
    ...
    { "id": 182, "name": "Saint Barthelemy", "cities": ["Gustavia"] },
    { "id": 183, "name": "Saint Helena", "cities": ["Jamestown"] },
    { "id": 184, "name": "Saint Kitts and Nevis", "cities": ["Basseterre"] },
    { "id": 185, "name": "Saint Lucia", "cities": ["Castries"] },
    { "id": 186, "name": "Saint Martin", "cities": ["Marigot"] },
    { "id": 187, "name": "Saint Pierre and Miquelon", "cities": ["Saint-Pierre"] },
    {
        "id": 188,
        "name": "Saint Vincent and the Grenadines",
        "cities": ["Kingstown", "Kingstown Park"]
    },
    { "id": 189, "name": "Samoa", "cities": ["Apia"] },
    { "id": 190, "name": "San Marino", "cities": ["San Marino"] },
    { "id": 191, "name": "Sao Tome and Principe", "cities": ["São Tomé"] },
    {
        "id": 192,
        "name": "Saudi Arabia",
        "cities": [
    ...
    { "id": 195, "name": "Seychelles", "cities": ["Victoria"] },
    {
        "id": 196,
        "name": "Sierra Leone",
        "cities": [
    ...
    { "id": 197, "name": "Singapore", "cities": ["Singapore"] },
    { "id": 198, "name": "Sint Maarten", "cities": ["Philipsburg"] },
    {
        "id": 199,
        "name": "Slovakia",
        "cities": [
    ...
    { "id": 201, "name": "Solomon Islands", "cities": ["Honiara"] },
    {
        "id": 202,
        "name": "Somalia",
        "cities": [
    ...
    { "id": 204, "name": "South Georgia and the South Sandwich Islands", "cities": ["Grytviken"] },
    {
        "id": 205,
        "name": "South Korea",
        "cities": [
    ...
    { "id": 210, "name": "Suriname", "cities": ["Paramaribo", "Lelydorp"] },
    { "id": 211, "name": "Svalbard and Jan Mayen", "cities": ["Longyearbyen"] },
    { "id": 212, "name": "Swaziland", "cities": ["Mbabane", "Manzini", "Lobamba"] },
    {
        "id": 213,
        "name": "Sweden",
        "cities": [
    ...
    { "id": 221, "name": "Tonga", "cities": ["Nuku‘alofa"] },
    {
        "id": 222,
    ...
    { "id": 226, "name": "Turks and Caicos Islands", "cities": ["Cockburn Town"] },
    { "id": 227, "name": "Tuvalu", "cities": ["Funafuti"] },
    { "id": 228, "name": "U.S. Virgin Islands", "cities": ["Charlotte Amalie", "Saint Croix"] },
    {
        "id": 229,
        "name": "Uganda",
        "cities": [
    ...
    { "id": 236, "name": "Vanuatu", "cities": ["Port-Vila"] },
    { "id": 237, "name": "Vatican", "cities": ["Vatican City"] },
    {
        "id": 238,
        "name": "Venezuela",
        "cities": [
    ...
    { "id": 240, "name": "Wallis and Futuna", "cities": ["Mata-Utu"] },
    { "id": 241, "name": "Western Sahara", "cities": ["Smara", "Laâyoune / El Aaiún", "Dakhla"] },
    {
        "id": 242,
        "name": "Yemen",
        "cities": [
